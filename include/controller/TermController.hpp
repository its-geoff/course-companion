...
#include "db/TermRepository.hpp"            // for TermRepository
...
class TermController {
    private:
        ...
        TermRepository termRepo_;                                   // repository for term persistence
    ...
    public:
        ...
        void loadFromDb();  // loads all terms from the database into termList_ on startup
