 ...
 *
 * Wraps MySQL Connector/C++ session management. A single DatabaseConnection instance is created at
 * startup and passed by reference to each repository. Repositories do not own the session.
 *
